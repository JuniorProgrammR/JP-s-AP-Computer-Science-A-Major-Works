// This file was provided by ProjectSTEM, it is the executable file for Assignment 9 and has no student modifications to it.

import java.util.ArrayList;
import java.util.Scanner;

public class Assignment9_runner_Ultimate{
